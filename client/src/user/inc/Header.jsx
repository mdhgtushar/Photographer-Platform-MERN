...
const Header = () => {
  return (
    <div className="flex items-center justify-center w-full border-b border-black-100 fixed left-0 bg-white">
      <div className="flex flex-1">
        ...
        <form className="flex-1 flex items-center justify-center">
          <div className="flex-1">
            <input
              className="border border-black-100 p-1 w-full outline-none "
              type="text"
            />
          </div>
          <div>
